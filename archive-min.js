...
// 构建名称
var archiveFilePath = path.join(__dirname, package.name + '-min-' + package.version + '-' + moment().format("YYYYMMDDHHmmss") + '.zip');
	// 设置打包路径
	...
	//设置打包文件
	var zipList=['app.js','package.json', 'config/**', 'controller/**',  'models/**',  'public/**', 'views/**'];
	//打包运行库
