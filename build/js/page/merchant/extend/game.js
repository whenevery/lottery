WY.ready('user-member-obj',function(merchantObj){
    merchantObj.game = {
        init:function(){
            ...
            $('.swiper-game  .to-back-score-btn').click(function(){
               that.backBet();
            });
        },
        reset:function(){
        ...
        doSearch:function(sts){
            ...
            $.get('/game/list',{
                ...
                status:this.searchForm.find('[name=status]').val(),
                page:this.page,
        ...
        setData:function(data,sts){
            ...
            $.each(data.data , function(i , o){
                ...
                $tr.append('<td>' +
                    '<a class="btn btn-sm color-999" href="/merchant/game/detail?gameId='+o.id+'">详情</a>' +
                    '</td>');
        ...
        backBet:function(){
            var that = this;
            $.post('/game/lottery/back',function(a){
